      ...
      <div className="container">
        <section className="landing-simple-section faq-section">
          ...
          <div className="faq-list">
            ...
            <details>
              <summary><span>Misafir kullanımında neler açık?</span><span className="faq-chevron" aria-hidden="true"><svg viewBox="0 0 20 20"><path d="m5 7 5 6 5-6" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg></span></summary>
